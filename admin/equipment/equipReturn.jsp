	...
	<div id="wrapper">
		...
		<div id="page-wrapper">
			...
			<div class="panel panel-default">
				<div class="panel-heading">장비 회수</div>
				<!-- /.panel-heading -->
						...
						<div class="col-lg-6">
							<form role="form">
								<div class="form-group">
									<label>기관명</label> <input class="form-control">
								</div>
								<div class="form-group">
									<label>장비명</label> <input class="form-control">
								</div>
								<div class="form-group">
									<label>요청사유</label> <input class="form-control">
								</div>
								<label>계약기간</label>
								<div class="srchWrap">
									<div class="termSelBox">
										<i class="fa fa-calendar fa-fw"></i> <input type="text"
											placeholder="시작 날짜" class="datepicker-here selector"
											style="width: 45%; padding: 6px 12px; font-size: 14px; line-height: 1.42857143; color: #555; background-color: #fff; background-image: none; border: 1px solid #ccc; border-radius: 4px;"
											data-language="kr" /> <span class="unit">~</span> <input
											type="text" placeholder="종료 날짜"
